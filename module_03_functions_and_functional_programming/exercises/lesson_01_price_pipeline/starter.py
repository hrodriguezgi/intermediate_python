...
if __name__ == "__main__":
    ...
    result1 = apply_transformations("100", apply_tax_19, round_price)
    ...
    result2 = apply_transformations("100", apply_tax_19, apply_discount_10, round_price)
    ...
    # Salida esperada: [60.5, 91.36, 242.0] (redondeado a 2 decimales)
    results3 = [apply_transformations(price, apply_tax_21, round_price) for price in prices]
